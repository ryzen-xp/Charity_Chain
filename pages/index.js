        ...
        <Container py={{ base: "4", md: "12" }} maxW={"7xl"} id="howitworks">
          ...
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10} py={8}>
            <Feature
              ...
              title={"Register NGO for Fundraising"}
              text={
                "It’ll take only 2 minutes. Just enter a few details about the NGO."
              }
            />
            <Feature
              icon={<Icon as={FcShare} w={10} h={10} />}
              title={"Share your NGO Campaign"}
              text={
                "All you need to do is share the NGO Campaign with your friends, family and others. In no time, support will start pouring in."
              }
            />
            <Feature
